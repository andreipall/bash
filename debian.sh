...
apt-get install pipewire-pulse xfce4 exfatprogs eject sassc firefox-esr mousepad ristretto thunar-archive-plugin xfce4-notifyd xfce4-screenshooter xfce4-terminal gvfs-backends fonts-noto xarchiver 7zip unzip parole network-manager-applet gstreamer1.0-libav gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly gnome-icon-theme tumbler ca-certificates pavucontrol lightdm lightdm-gtk-greeter ufw bleachbit --no-install-recommends
